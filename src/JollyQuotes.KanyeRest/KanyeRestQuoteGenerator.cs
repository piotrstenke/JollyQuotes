...
namespace JollyQuotes.KanyeRest
{
	...
	{
		private const string _baseAddress = KanyeRestResources.MainPage;
		...
		/// </summary>
		public KanyeRestQuoteGenerator() : base(_baseAddress, false)
		{
		...
		public KanyeRestQuoteGenerator(
			...
			IQuoteCache<KanyeRestQuote>? cache = null,
			IPossibility? possibility = null
		) : base(GetResolverFromService(service), _baseAddress, cache, possibility)
		{
			Service = service;
		}
